...
router.put("/:id", authMiddleware, async (req, res) => {
  ...
  try {
    ...
    // Cascade: actualizar datos del cliente en tabla clientes
    if (finalClienteId) {
      await client.query(
        `UPDATE clientes SET razon_social = $1, direccion = $2, comuna = $3, contacto_nombre = $4, telefono = $5 WHERE id = $6`,
